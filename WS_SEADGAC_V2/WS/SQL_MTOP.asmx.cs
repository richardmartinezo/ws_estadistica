...
{
    /// <summary>
    /// Summary description for SQL_MTOP
    /// </summary>
    ...
    public class SQL_MTOP : System.Web.Services.WebService
    {

        private List<SQL_List_WS> lista_IngresoMTOP;
        ...
        public List<SQL_List_WS> WebServiceDGAC(string fecha_ini, string fecha_fin, string type, string nacionality)
        {
            ...
            lista_IngresoMTOP = new List<SQL_List_WS>();
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    lista_IngresoMTOP.Add(sql_List_WS);
                }
                connection.Close();
            }
            catch (Exception)
